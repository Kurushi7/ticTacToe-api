...
--
-- Table structure for table `games_summary`
--

DROP TABLE IF EXISTS `games_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `games_summary` (
  `game_id` int(11) NOT NULL,
  `games_summarycol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`game_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `games_summary`
--

LOCK TABLES `games_summary` WRITE;
/*!40000 ALTER TABLE `games_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `games_summary` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-10-08  9:43:37
